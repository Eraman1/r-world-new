...
import { MapPin, Phone, ArrowUp, Youtube } from 'lucide-react';
        ...
        <footer className="bg-gray-100 relative">
            ...
            <div className="max-w-7xl mx-auto px-4 py-12">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="space-y-2">
                                <div className="flex items-center space-x-2">
                                    <img src="/api/placeholder/20/12" alt="US Flag" className="w-5 h-3" />
                                    <span className="text-gray-700 text-sm">Phone: 954 342 5676</span>
                                </div>
                                <div className="flex items-center space-x-2">
                                    <img src="/api/placeholder/20/12" alt="UK Flag" className="w-5 h-3" />
                                    <span className="text-gray-700 text-sm">Phone: +44 137 243 2466</span>
                                </div>
                            </div>
                    ...
                    {/* Industries - Column 2 */}
                    <div className="lg:col-span-1">
                        <h3 className="text-lg font-bold text-gray-800 mb-4 lg:text-transparent">INDUSTRIES</h3>
                        <ul className="space-y-2">
