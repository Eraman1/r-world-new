  ...
  const testimonials = [
    {
      ...
      image: "AA",
      quote:
        "R-World provides an environment where I can grow every day. As a Software Engineer, I get to solve real problems, work with new technologies, and continuously improve my skills. The learning culture here keeps me motivated and excited about my work.",
    },
    {
      name: "Pratham Kumar",
      ...
      image: "PK",
      quote:
        "At R-World, creativity is valued and encouraged. As a Graphic Designer, I enjoy collaborating with different teams to bring ideas to life. The supportive environment and innovative projects help me grow professionally and creatively.",
    },
    {
      name: "Ravi Kumar",
      ...
      image: "RK",
      quote:
        "R-World’s focus on innovation and employee development has helped me grow as an Associate Software Engineer. The leadership team values our ideas and provides continuous support, making it a great place to build a strong career.",
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-[#000000] text-lg max-w-4xl mx-auto leading-relaxed">
            R-World promotes an atmosphere that embraces continual learning at
            both the industrial and technological levels. The fact that each day
            I am faced with a new opportunity to learn and grow is one reason I
            love working at R-World.
          </p>
        </div>
                ...
                <div className="bg-[#E5E5E5] rounded-2xl p-6 relative">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <div>
                        <p className="text-[#14213D] font-bold text-lg">
                          {testimonial.name}
                        </p>
                        <p className="text-[#FCA311] font-semibold text-sm">
