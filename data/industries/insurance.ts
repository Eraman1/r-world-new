...
export const insurance: IndustryConfig = {
  ...
  managementSolutions: {
    ...
    laptopImage:
      "https://i.pinimg.com/1200x/12/8d/a2/128da2fa9de271ca3db65c6ba957f68f.jpg",
    mobileImage:
      "https://i.pinimg.com/736x/04/c5/5d/04c55d30e921b1b74cf1fc44fed0bbae.jpg",
    topFeatures: [
      {
  ...
  managementSolutionsTwo: {
    ...
    laptopImage:
      "https://i.pinimg.com/1200x/be/d8/eb/bed8eb873a8c5ee7f43ef6445b7fb578.jpg",
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        id: "9",
        question:
          "Are there digital solutions for managing insurance policies?",
        answer:
