...
export const telecommunications: IndustryConfig = {
  ...
  banner: {
    ...
    image: "/industry/industryTelecomBanner.webp",
  ...
  techHero: {
    ...
    deviceImages: {
      laptop: "/industry/industryTelecomBanner.webp",
      tablet: "/industry/industryTelecomBanner.webp",
      mobile: "/industry/industryTelecomBanner.webp",
    },
  },
  ...
  managementSolutions: {
    ...
    laptopImage:
      "https://i.pinimg.com/736x/75/6a/a3/756aa3c54d6e62e9ea445745763992b2.jpg",
    mobileImage:
      "https://i.pinimg.com/736x/88/94/65/889465937a261b646ae120c350339dd5.jpg",
    topFeatures: [
      {
        id: "match-analytics",
        icon: "map",
  ...
  managementSolutionsTwo: {
    ...
    laptopImage:
      "https://i.pinimg.com/1200x/19/3b/67/193b671a32af83fa3c6b44c1f140ad05.jpg",
