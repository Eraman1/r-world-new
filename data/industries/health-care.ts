...
export const healthcare: IndustryConfig = {
  ...
  banner: {
    ...
    image: "/industry/industryHealthcareBanner.webp",
  ...
  managementSolutions: {
    ...
    laptopImage:
      "https://i.pinimg.com/736x/10/6d/8f/106d8f44e6553b17498896984376bb62.jpg",
    mobileImage:
      "https://i.pinimg.com/736x/e4/75/a2/e475a274839246482835e19e5c6a0301.jpg",
    topFeatures: [
      {
        id: "ehr-integration",
        icon: "map",
  ...
  managementSolutionsTwo: {
    ...
    subtitleLink: { text: "healthcare management software", url: "#" },
    laptopImage:
      "https://i.pinimg.com/1200x/ba/52/89/ba528974ead83742fe6661d3f783af08.jpg",
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        id: "7",
        question:
          "Can digital healthcare solutions integrate with existing hospital systems?",
        answer:
