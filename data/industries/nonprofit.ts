...
export const nonprofit: IndustryConfig = {
  ...
  banner: {
    ...
    image: "/industry/industryNonprofitBanner.webp",
  ...
  managementSolutions: {
    ...
    mobileImage:
      "https://i.pinimg.com/1200x/74/29/e2/7429e2f1931d41e4abb8600cd684c5a2.jpg",
    topFeatures: [
      {
  ...
  managementSolutionsTwo: {
    ...
    laptopImage:
      "https://i.pinimg.com/736x/3a/92/47/3a924788f85935ca8fe494840e119fa0.jpg",
    mobileImage: "",
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        id: "3",
        question:
          "What types of fundraising platforms are available for nonprofits?",
        answer:
