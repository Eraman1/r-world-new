...
export const lending: IndustryConfig = {
  ...
  banner: {
    ...
    image: "/industry/industryLendingBanner.webp",
  ...
  managementSolutions: {
    ...
    laptopImage:
      "https://i.pinimg.com/736x/8e/c1/c1/8ec1c15bacb36678797d8eae6cfc5739.jpg",
    mobileImage:
      "https://i.pinimg.com/1200x/9c/21/5f/9c215f4d19b4ca56098cbe2e856ac9ea.jpg",
    topFeatures: [
      {
        id: "loan-lifecycle",
        icon: "map", //RefreshCcw
  ...
  managementSolutionsTwo: {
    ...
    subtitleLink: { text: "loan management software", url: "#" },
    laptopImage:
      "https://i.pinimg.com/1200x/ea/9b/0b/ea9b0b8e163dd22d59c15f942040f632.jpg",
    ...
    items: [
      {
        id: "1",
        question:
          "What types of loans are available through lending platforms?",
        answer:
