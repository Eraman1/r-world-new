...
export const eLearningEducation: IndustryConfig = {
  ...
  banner: {
    ...
    image: "/industry/industryELearningBanner.webp",
  ...
  managementSolutions: {
    ...
    laptopImage:
      "https://i.pinimg.com/1200x/8f/24/1d/8f241d0ca75763f23d3a541c8c86be93.jpg",
    mobileImage:
      "https://i.pinimg.com/736x/9b/49/18/9b4918aae0a814902440b71fc49e17d7.jpg",
    topFeatures: [
      {
        id: "content",
        icon: "Tractor", //layers
  ...
  managementSolutionsTwo: {
    ...
    laptopImage:
      "https://i.pinimg.com/1200x/86/39/f8/8639f8aac6b82300ecf488e19d394022.jpg",
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        id: "2",
        question:
          "How do E-Learning solutions benefit educational institutions?",
        answer:
      ...
      },
      {
        id: "8",
        question:
          "Can E-Learning platforms integrate with existing school systems?",
        answer:
