...
export const supplyChain: IndustryConfig = {
  ...
  banner: {
    ...
    image: "/industry/industrySupplyChainManagementBanner.webp",
...
Ensure transparency and accountability across your supply chain network.`,
  ...
  managementSolutions: {
    ...
    laptopImage:
      "https://i.pinimg.com/736x/8a/48/f6/8a48f6c675d6fb0e834553779f7c9893.jpg",
    mobileImage:
      "https://i.pinimg.com/736x/5b/c2/ff/5bc2ffee4e6b29029dee5d90caf402f4.jpg",
    topFeatures: [
      {
        id: "match-analytics",
        icon: "map",
  ...
  managementSolutionsTwo: {
    ...
    laptopImage:
      "https://i.pinimg.com/736x/30/b9/9e/30b99e3d6614366d8fcb63ece3d05fb7.jpg",
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        id: "7",
        question:
          "How can businesses ensure sustainability in their supply chains?",
        answer:
      ...
      },
      {
        id: "9",
        question:
          "How does predictive analytics benefit supply chain management?",
        answer:
