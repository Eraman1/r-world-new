...
export const payments: IndustryConfig = {
  ...
  banner: {
    ...
    image: "/industry/industryPaymentBanner.webp",
  ...
  managementSolutions: {
    ...
    laptopImage:
      "https://i.pinimg.com/736x/1d/29/f6/1d29f64b1ebf132ba08687cf0ed0f121.jpg",
    mobileImage:
      "https://i.pinimg.com/736x/fe/21/89/fe21894015d2044fc06cb67a408ff931.jpg",
    topFeatures: [
      {
  ...
  managementSolutionsTwo: {
    ...
    laptopImage:
      "https://i.pinimg.com/1200x/ae/3a/55/ae3a55d15d6fbf02b713e80057e8e11b.jpg",
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        id: "3",
        question:
          "What is the difference between a wallet and a bank transfer?",
        answer:
