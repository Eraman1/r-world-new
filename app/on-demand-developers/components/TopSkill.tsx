      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8 lg:gap-12">
          {solutions && solutions.map((solution) => (
            ...
            >
              {/* Icon */}
              <div className="mb-6 transition-transform durati¬on-300 group-hover:scale-110 group-hover:-translate-y-2">
                 {iconsMap[solution.icon]}
              </div>

              {/* Title */}
              <Link href={linkUrl || ""} className="text-xl sm:text-2xl font-bold text-gray-900 mb-1">
                {solution.title}
              </Link>
