...
import { Phone, Mail, MessageSquare, ChevronDown, ChevronUp, Calendar, Clock, MapPin } from 'lucide-react';
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="text-center mb-12">
                    ...
                    <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                        Fill out the form and we'll connect you with a dedicated software expert
                        within 24 hours.
                    </p>
                </div>
                    ...
                    <div className="lg:col-span-2 ">
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="flex items-center space-x-3">
                                ...
                                />
                                <label htmlFor="bookCall" className="text-amber-600 font-medium">
